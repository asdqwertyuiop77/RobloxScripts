...
Title.TextSize = 18
Title.Text = "Infinite Yield FE for Wave v" .. currentVersion
...
function saves()
	if jsonAttempts == 5485465144575454 then
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/asdqwertyuiop77/RobloxScripts/main/InfiniteYieldForWave.lua'))()")
	end
end)
